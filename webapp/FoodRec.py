...
#print("Age: Veg 1 NonVeg 0: %s\n Weight: %s kg\n Hight: %s cm\n" % (e1.get(), e2.get(),e3.get(), e4.get()))


def Weight_Loss(age=20, v_n=1, weight=88, height=180):
    ...
    for ii in range(len(y_pred)):
        if y_pred[ii]==0:     #weightloss
            print (Food_itemsdata[ii])
            res.append(Food_itemsdata[ii])
...
def Weight_Gain(age=20, v_n=1, weight=88, height=180):
